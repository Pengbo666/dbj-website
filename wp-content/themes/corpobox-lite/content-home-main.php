...
<div id="home-tagline" style="background: <?php echo esc_attr( get_theme_mod( 'home_tagline_bgcolor', '#e8e09d' ) ); ?> url(<?php echo esc_attr( get_theme_mod( 'home_tagline_bgimg', get_template_directory_uri().'/img/tagline.jpg' ) ); ?>); background-position: 50%; background-size:100%;">
