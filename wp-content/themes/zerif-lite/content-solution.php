...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header">
		...
		the_title(); 
		$post_id = $post->ID;
		echo $descriptions = get_post_meta($post_id, 'descriptions', true);
		echo $icon = get_post_meta($post_id,'icon-img',true);
		?></a></h1>
	...
	<footer class="entry-footer">
		...
		<span class="comments-link"><?php //comments_popup_link( __( 'Leaves a comment', 'zerif-lite' ), __( '1 Comment', 'zerif-lite' ), __( '% Comments', 'zerif-lite' ) ); ?></span>
